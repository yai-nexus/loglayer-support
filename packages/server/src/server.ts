 ...
 * @returns LogLayer 实例
 */
export async function createServerLogger(name: string, config?: LoggerConfig): Promise<LogLayer> {
 ...
 * @returns 简化的管理器
 */
export function createServerLoggerManager(globalConfig?: Partial<LoggerConfig>): any {
  // 简化实现，返回基础管理器
  return {
 ...
 * @returns LogLayer 实例
 */
export function createNextjsServerLogger(config?: Partial<LoggerConfig>): Promise<LogLayer> {
 ...
 * @returns LogLayer 实例
 */
export function createExpressServerLogger(config?: Partial<LoggerConfig>): Promise<LogLayer> {
