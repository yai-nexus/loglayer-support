...
import { createAutoLogger } from '../../packages/server/dist';
import type { AutoLoggerConfig } from '../../packages/server/dist';

// ==================== 测试配置 ====================

const testConfig: AutoLoggerConfig = {
  app: {
    name: 'test-app',
  ...
  outputs: {
    ...
    file: { enabled: true, path: './test-logs', filename: 'test.log' },
    sls: { enabled: false }
  },
  features: {
